...
import rise.arithmetic.BoolExpr.ArithPredicate.Operator
import rise.arithmetic.NotEvaluableException._
import rise.arithmetic.NotEvaluableToIntException._
